...
//    "this" is the joe object created on line 149.

// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this" is the global window object.

// 3. Explain why "this" is different when an arrow function is used.
//    When an arrow function is used, the scope of the function goes up to the next nearest scope. In this case, the scopeArrow() function is used exclusively so the "this" is the next nearest scope which is the global window object.
